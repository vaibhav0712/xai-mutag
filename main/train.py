from torch_geometric.nn import RGCNConv, FastRGCNConv, global_mean_pool
...
if __name__ == "__main__":
    ...
    torch.save(checkpoint, models_dir / 'gnn_model_checkpoint.pt')
    print("[INFO] Saved successfully as 'gnn_model_checkpoint.pt'")